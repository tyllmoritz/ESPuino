...
* `upload_port` and `monitor_port` should be autodetected (by the USB-ID of the serial-adapter). If this fails, please set these values depending on your operating system (Windows, Mac OS, Linux).
